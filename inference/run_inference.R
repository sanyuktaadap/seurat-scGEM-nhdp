...
MODEL_PATH = "model/R_nHDPresults_binary_tnk_three_layer_20230620.RData"

if (file.exists(SPARSE_PATH)) {
  load(SPARSE_PATH)
  colnames(query_df_sparse) <- query_df_colnames
  rownames(query_df_sparse) <- query_df_rownames
} else {
